...
#' DYNPROG: A package for applying Change Point Detection by Dynamic Programming
#'
...
#' Applies DYNPROG algorithm to the given data data.mat
#'
...
#'
#' @export
DYNPROG <- function(data.dt, max.segments) {
